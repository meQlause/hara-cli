...
|--------|------|-------------------------------|
| UINT256 | `0x01` | `uint8`…`uint256`, `int*`   |
| ADDRESS | `0x02` | `address`                    |
| BOOL    | `0x03` | `bool`                       |
| BYTES32 | `0x04` | `bytes1`…`bytes32`           |
| STRING  | `0x05` | `string`                     |
| BYTES   | `0x06` | `bytes`                      |
...
| Format       | Size (Bytes) | Efficiency |
|--------------|--------------|------------|
| Pretty JSON  | 934 B        | 100%       |
| Minified JSON| 521 B        | 55.7%      |
| ABI binary   | **71 B**     | **7.6%**   |

Total entries = **3** (1 function + 1 event + 1 error).
Total encoded size = **71 bytes**.
